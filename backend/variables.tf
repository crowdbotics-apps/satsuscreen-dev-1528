variable "app_name" {
  ...
  type = "string"
  default = "satsuscreen-dev-1528"
}

variable "custom_domain" {
  description = "Custom domain name (optional)"
  type = "string"
  default = "satsuscreen-dev-1528.botics.co"
}
...
variable "repo_url" {
    ...
    type = "string"
    default = "https://github.com/crowdbotics-apps/satsuscreen-dev-1528/archive/master.tar.gz"
}
